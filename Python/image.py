...
"""
Python Image Representation (modified from MIT 6.865 & Kylie Ying)
"""

import numpy as np
import png

# MARKUP - : initialize with X PIXELS | Y PIXELS | NUM CHANNELS | FILENAME 

class Image:
    def __init__(self, x_pixels=0, y_pixels=0, num_channels=0, filename=''):
        
        # MARKUP - : paths for INPUTS and OUTPUTS

        self.input_path = 'input/'
        self.output_path = 'output/'

        # MARKUP - : if statement to check if image input exists
